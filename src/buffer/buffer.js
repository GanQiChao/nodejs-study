...
let buf5 = Buffer.from('tést')
console.log(buf5.toString())

// 创建一个包含 Latin-1 字节 [0x74, 0xe9, 0x73, 0x74] 的 Buffer。
let buf6 = Buffer.from('tést', 'latin1')
console.log(buf6)
...
console.log('buffer length: (alloc)' + buffer.length)
buffer.write('abcdefghijklmnopqrstuvwxyz')
console.log('buffer length: (alloc)' + buffer.length, buffer.toString('ascii'))
buffer.write('123')
console.log('buffer length: (alloc)' + buffer.length, buffer.toString('ascii'))
